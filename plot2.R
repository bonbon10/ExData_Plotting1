...
# Plot 2: Line graph of Global Active Power for Thursday, Friday, and Saturday
png(filename="plot2.png")
with(subdat, plot(Date.Time, Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)"))
dev.off()